...
export const ChatPromptInput = forwardRef<ChatPromptInputHandle, ChatPromptInputProps>(
  ({
    ...
    return (
      <div
        className={`${docked ? '' : 'mt-[30px] md:mt-20'} w-full max-w-[860px] mx-auto transition-all duration-500 ease-out ${isMountAnimationReady ? 'translate-y-0 opacity-100' : 'translate-y-3 opacity-0'
          }`}
      >
        <div
